<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="com.infrastructure.extension.UrlHelper" %>
    ...
    <%@ include file="../shared/taglib.jsp" %>
        ...
        <head>
            ...
            <%@ include file="../shared/importCss.jsp" %>
                ...
                <link rel="stylesheet" href="<c:url value='/static/plugins/data-tables/DT_bootstrap.css'/>" type="text/css" />
                <!-- END PAGE LEVEL STYLES -->

                <%@ include file="../shared/importJs.jsp" %>
                    <!-- BEGIN PAGE LEVEL SCRIPTS -->
                    <script type="text/javascript" src="<c:url value='/static/plugins/data-tables/jquery.dataTables.js'/>"></script>
                    <script type="text/javascript" src="<c:url value='/static/plugins/data-tables/DT_bootstrap.js'/>"></script>
                    <script type="text/javascript" src="<c:url value='/static/plugins/uniform/jquery.uniform.min.js'/>"></script>
                ...
                <div class="page-container">
                  ...
                  Form Controls <small>form controls and more</small>
                                        ...
                                        <ul class="page-breadcrumb breadcrumb">
                                            ...
                                            <li><span>${requestScope.permissionMenu.subName}</span>
                                            </li>
                                        </ul>
                        ...
                        $(function() {
                            ...
                            $(".table-toolbar").toolbarLite({
                                items: [{
                                    ...
                                    css: "icon-ok",
                                    showIcon: true,
                                    url: "<%=UrlHelper.resolveWithReturnUrl("/account/enable/{0}", 
                                    		request.getAttribute("requestUrl "),
                                    		request.getAttribute("requestQuery "), pageContext)%>",
                                    selector: "#data-table .checkboxes",
                                    mustSelect: "请先选择数据！",
                                    singleSelect: "该操作只支持单选！"
                                }, {
                                    splitter: true
                                }, {
                                    link: true,
                                    ...
                                    css: "icon-remove",
                                    showIcon: true,
                                    url: "<%=UrlHelper.resolveWithReturnUrl("/account/disable/{0}",
                                    		request.getAttribute("requestUrl "), 
                                    		request.getAttribute("requestQuery "), pageContext)%>",
                                    selector: "#data-table .checkboxes",
                                    mustSelect: "请先选择数据！",
                                    ...
                                    css: "icon-user",
                                    showIcon: true,
                                    url: "<%=UrlHelper.resolveWithReturnUrl("/account/authorize/{0}", 
                                    		request.getAttribute("requestUrl"), 
                                    		request.getAttribute("requestQuery"), pageContext)%>",
                                    selector: "#data-table .checkboxes",
                                    mustSelect: "请先选择数据！",
                                    ...
                                    css: "icon-trash",
                                    showIcon: true,
                                    url: "<%=UrlHelper.resolveWithReturnUrl("/account/delete/{0}", 
                                    		request.getAttribute("requestUrl"), 
                                    		request.getAttribute("requestQuery"), pageContext)%>",
                                    selector: "#data-table .checkboxes",
                                    mustSelect: "请先选择数据！",
