...
<div class="page-sidebar navbar-collapse collapse">
	<ul class="page-sidebar-menu">
		...
		<c:forEach
			items="${sessionScope.accountAuth.accountRole.authorityMenus}"
			...
			<a href="javascript:;"> <i
				class='${ empty item.itemIcon?"icon-list": item.itemIcon}'></i> <span
				class="title">${ item.name }</span> <span class="arrow "></span>
			</a>
	...
	<li class="last"><a href="login.html"> <i class="icon-off"></i>
