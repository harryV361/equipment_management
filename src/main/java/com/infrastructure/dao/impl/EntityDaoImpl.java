...
import com.infrastructure.model.ICreatable;
import com.infrastructure.model.IDeletable;
import com.infrastructure.model.IUpdatable;
...
public abstract class EntityDaoImpl<PKType extends Number, EntityType extends Entity<PKType>>
		implements EntityDao<PKType, EntityType> {
	...
	protected void checkCreatable(EntityType entity)
			throws EntityOperateException {
		if (!(entity instanceof ICreatable))
			throw new EntityOperateException(
					"the entity not support ICreatable!");
	}

	protected void checkUpdatable(EntityType entity)
			throws EntityOperateException {
		if (!(entity instanceof IUpdatable))
			throw new EntityOperateException(
					"the entity not support IUpdatable!");
	}

	protected void checkDeletable(EntityType entity)
			throws EntityOperateException {
		if (!(entity instanceof IDeletable))
			throw new EntityOperateException(
					"the entity not support IDeletable!");
	}

	protected void checkCreatableOrUpdatable(EntityType entity)
			throws EntityOperateException {
		if (!(entity instanceof ICreatable) && !(entity instanceof IUpdatable))
			throw new EntityOperateException(
					"the entity not support ICreatable or IUpdatable throw by merge!");
	}
	...
	@Override
	public void save(EntityType entity) throws EntityOperateException,
			ValidatException {
		checkNull(entity);
	...
	@Override
	public void update(EntityType entity) throws EntityOperateException,
			ValidatException {
		checkNull(entity);
	...
	@Override
	public void delete(EntityType entity) throws EntityOperateException,
			ValidatException {
		checkNull(entity);
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<EntityType> listPage(int start, int limit, String orderName,
			boolean orderASC) {
		Criteria criteria = getCriteria();
		if (orderName != null) {
			if (orderASC)
