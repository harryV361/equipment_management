...
public abstract class ChainEntityDaoImpl<PKType extends Number, EntityType extends ChainEntity<PKType, EntityType>> 
	extends EnableEntityDaoImpl<PKType, EntityType> implements ChainEntityDao<PKType, EntityType> {
