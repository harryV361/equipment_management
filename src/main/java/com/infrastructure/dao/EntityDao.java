...
public interface EntityDao<PKType extends Number, EntityType extends Entity<PKType>> {
	/**
	 * 根据id获取对应的对象
	 * 
	 * @param id
	 ...
	 * @throws ValidatException
	 */
	public void save(EntityType model) throws EntityOperateException,
			ValidatException;
	 ...
	 * @throws ValidatException
	 */
	public void update(EntityType model) throws EntityOperateException,
			ValidatException;
	 ...
	 * @throws ValidatException
	 */
	public void delete(EntityType model) throws EntityOperateException,
			ValidatException;
