...
public class AuthHelper {
	...
	public static void setSessionAccountAuth(HttpServletRequest request,
	...
	public static void setRequestPermissionMenu(HttpServletRequest request,
			PermissionMenu permissionMenu) {
		request.setAttribute("permissionMenu", permissionMenu);
	}

	public static PermissionMenu getRequestPermissionMenu(
