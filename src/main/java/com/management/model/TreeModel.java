...
public class TreeModel {
	...
	/*
	 * public TreeModel(String id, String value, String text, boolean checked,
	 * boolean selected){ this.id=id; this.value=value; this.text=text;
	 * this.checked=checked; this.selected=selected; this.collpase=false;
	 * this.children=null; }
	 */
