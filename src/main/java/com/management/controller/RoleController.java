...
import com.infrastructure.extension.ArrayHelper;
...
import com.management.model.extension.RoleBindModelExtension;
import com.management.model.extension.RoleModelExtension;
...
public class RoleController extends BaseController {
	...
	public String bind(HttpServletRequest request, Model model, @PathVariable(value = "id") Integer id) throws ValidatException {
		...
		List<TreeModel> children = TreeModelExtension.ToTreeModels(authorityService.listChain(), null, checkedAuthorityIds,
	...
	public String bind(HttpServletRequest request, Model model, @Valid @ModelAttribute("contentModel") RoleBindModel roleBindModel,
			@PathVariable(value = "id") Integer id, BindingResult result) throws ValidatException, EntityOperateException {
		if (result.hasErrors())
