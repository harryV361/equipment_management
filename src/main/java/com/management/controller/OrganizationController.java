...
import com.management.model.OrganizationEditModel;
import com.management.model.TreeModel;
import com.management.model.extension.OrganizationModelExtension;
import com.management.model.extension.TreeModelExtension;
...
public class OrganizationController extends BaseController {
	...
	public String add(HttpServletRequest request, Model model, @Valid @ModelAttribute("contentModel") OrganizationEditModel editModel,
			@PathVariable(value = "id") Integer id, BindingResult result) throws EntityOperateException, ValidatException {
		if (result.hasErrors())
	...
	public String edit(HttpServletRequest request, Model model, @PathVariable(value = "id") Integer id) throws ValidatException {
		...
		if (editModel.getParentId() != null && editModel.getParentId() > 0) {
			List<TreeModel> children = TreeModelExtension.ToTreeModels(organizationService.listChain(), editModel.getParentId(), null,
	...
	public String edit(HttpServletRequest request, Model model, @Valid @ModelAttribute("contentModel") OrganizationEditModel editModel,
			@PathVariable(value = "id") Integer id, BindingResult result) throws EntityOperateException, ValidatException {
		if (result.hasErrors())
